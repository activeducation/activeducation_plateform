...
// Graphiques, activite recente et cartes du dashboard, extraits pour
// alleger dashboard_page.dart. Extension (meme librairie) + widgets autonomes.

extension _DashboardCards on _DashboardPageState {
  String _getGreeting() {
