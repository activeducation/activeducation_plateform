...
///
/// Aucune donnee n'est envoyee si le DSN est vide (DEV par defaut).
/// [appRunner] est execute sous la zone Sentry en cas d'activation,
/// sinon il est execute directement.
