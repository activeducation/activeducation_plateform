...
print_summary() {
    ...
    echo "  ╠══════════════════════════════════════════════════════════════╣"
    echo "  ║                                                              ║"
    echo "  ║   App étudiante :   https://activeducationhub.com                ║"
    echo "  ║   Dashboard admin : https://admin.activeducationhub.com          ║"
    echo "  ║   API Backend :     https://api.activeducationhub.com            ║"
    echo "  ║                                                              ║"
...
main() {
    ...
    echo "    App         : https://activeducationhub.com"
    echo "    Admin       : https://admin.activeducationhub.com"
    echo "    API         : https://api.activeducationhub.com"
    echo ""
